...
第六章：这个部分主要就是对青年公寓服务平台进行整体测试，看看程序是否能够达到用户使用要求，程序能否进行验收上交操作。
...
本次开发青年公寓服务平台使用的是B/S结构模式进行程序开发，青年公寓服务平台的数据信息选择MySQL数据库进行存放。
...
![房屋](/md/blog.008.jpeg "房屋")
图4.1 房屋实体属性图

（2）下图是房屋留言实体和其具备的属性。

![房屋留言](/md/blog.009.jpeg "房屋留言")
图4.2 房屋留言实体属性图
...
![博客](/md/blog.011.jpeg "博客")
图4.4 博客实体属性图

（5）下图是博客留言实体和其具备的属性。

![博客留言](/md/blog.012.jpeg "博客留言")
图4.5 博客留言实体属性图

（6）下图是预约看房实体和其具备的属性。

![预约看房](/md/blog.013.jpeg "预约看房")
图4.6 预约看房实体属性图

（7）下图是博客收藏实体和其具备的属性。

![博客收藏](/md/blog.014.jpeg "博客收藏")
图4.7 博客收藏实体属性图

（8）下图是房屋投诉实体和其具备的属性。

![房屋投诉](/md/blog.015.jpeg "房屋投诉")
图4.8 房屋投诉实体属性图

（9）下图是房屋收藏实体和其具备的属性。

![房屋收藏](/md/blog.016.jpeg "房屋收藏")
图4.9 房屋收藏实体属性图

（10）下图是商家实体和其具备的属性。

![商家](/md/blog.017.jpeg "商家")
图4.10 商家实体属性图
